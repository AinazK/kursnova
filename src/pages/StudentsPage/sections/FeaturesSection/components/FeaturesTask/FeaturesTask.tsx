...
const TaskTag =
  "/wp-content/themes/kursnova-wp-theme/assets/students/features/task-tag.svg";

const Star =
  "/wp-content/themes/kursnova-wp-theme/assets/common/icons/star.svg";
const BackPackIcon =
  "/wp-content/themes/kursnova-wp-theme/assets/common/icons/backpack.svg";
const DumbbelIcon =
  "/wp-content/themes/kursnova-wp-theme/assets/common/icons/dumbbel.svg";
...
const TASK_DESCRIPTIONS = [
  {
    icon: <img src={DumbbelIcon} alt="Гантель" />,
    title: "6 000+ заданий",
    description: (
      <>
  ...
  {
    icon: <img src={BackPackIcon} alt="Рюкзак" />,
    title: "5 предметов",
    description: (
      <>
