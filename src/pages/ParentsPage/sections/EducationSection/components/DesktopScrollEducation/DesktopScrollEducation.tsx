...
const SharkImg =
  "/wp-content/themes/kursnova-wp-theme/assets/parents/education/education-shark.png";
// const PlayIcon = "/wp-content/themes/kursnova-wp-theme/assets/common/icons/play-icon.svg";
